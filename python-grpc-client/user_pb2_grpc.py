...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getUserDetails = channel.unary_unary(
                '/com.epam.trainning.grpc.protocols.UserService/getUserDetails',
...
def add_UserServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.epam.trainning.grpc.protocols.UserService', rpc_method_handlers)
...
class UserService(object):
    ...
    def getUserDetails(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.epam.trainning.grpc.protocols.UserService/getUserDetails',
